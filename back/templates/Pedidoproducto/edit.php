...
<div class="row">
    <aside class="column">
        <div class="side-nav">
            ...
            <?= $this->Form->postLink(
                __('Delete'),
                ['action' => 'delete', $pedidoproducto->idPedido],
                ['confirm' => __('Are you sure you want to delete # {0}?', $pedidoproducto->idPedido), 'class' => 'side-nav-item']
            ) ?>
    ...
    <div class="column-responsive column-80">
        <div class="pedidoproducto form content">
            ...
            <fieldset>
                <legend><?= __('Edit Pedidoproducto') ?></legend>
                <?php
